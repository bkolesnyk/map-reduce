...
public class MaxTemperatureUsingSecondarySort extends Configured implements Tool {
    ...
    static class MaxTemperatureMapper extends Mapper<LongWritable, Text, IntPair, NullWritable> {
        ...
        @Override
        protected void map(LongWritable key, Text value, WrappedMapper.Context context) throws IOException, InterruptedException {
            parser.parse(value);
    ...
    static class MaxTemperatureReducer extends Reducer<IntPair, NullWritable, IntPair, NullWritable> {
        @Override
        protected void reduce(IntPair key, Iterable<NullWritable> values, WrappedReducer.Context context) throws IOException, InterruptedException {
    ...
    public static class FirstPartitioner extends Partitioner<IntPair, NullWritable> {
        @Override
        public int getPartition(IntPair key, NullWritable value, int numPartitions) { // multiply by 127 to perform some mixing
